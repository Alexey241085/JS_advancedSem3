...
const result = document.addEventListener("click", (e) => {
  const classContain = e.target.classList.contains("super_element");
...
const d = textA.addEventListener("mouseover", (e) => {
...
const liEl = document.querySelectorAll("li button");
